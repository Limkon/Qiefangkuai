    ...
    if (path.endsWith('/css/style.css')) {
      ...
      return new Response(`// globalConfig.js
		...
		function renderScoreHud() {
			...
			cubeCountNode.innerText = \`方块粉碎: \${state.game.cubeCount}\`;
		}
		...
		function renderMenus() {
			...
			switch (state.menus.active) {
				...
				case MENU_SCORE:
					...
					if (isNewHighScore()) {
						highScoreLblNode.textContent = '新的最高分!';
					} else {
						highScoreLblNode.textContent = \`最高分: \${formatNumber(getHighScore())}\`;
					}
...
<html>
	<head>
		...
		<meta name="description" content="，切方块，小游戏和小工具的摸鱼网站。" /> 
	...
	<body>
		...
		<div class="menus">
			<div class="menu menu--main">
				...
				<div class="credits">一个 8 KB 的游戏 by<a href="http://haiyong.site/index"> X</a><br><br>
